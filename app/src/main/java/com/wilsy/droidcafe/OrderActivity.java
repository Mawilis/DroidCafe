...
public class OrderActivity extends AppCompatActivity implements OnItemSelectedListener, AdapterView.OnItemClickListener {
    ...
    public void showOrderDatePicker(View view) {
